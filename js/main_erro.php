...
<!-- Quando este arquivo é direcionado para o index, ocorre erro o qual ainda se encontra
em estudo. Foi criado um outro main.php que funciona, posteriormente irei compara-los
e descobrir o que tinha acontecido. -->

<!-- POSSÍVEL CORREÇÃO:

O arquivo se encontrava dentro da pasta js, e seu redirecionamento estava apenas main.php -->
...
<!--Armazenamento dos dados nas variáveis -->
<?php
	while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
        echo "<script> let dianteira_1 = '" . $row_usuario['valor1'] . "' </script> ";
        echo "<script> let centro_1 = '" . $row_usuario['valor2'] . "' </script> ";
        echo "<script> let traseira_1 = '" . $row_usuario['valor3'] . "' </script> ";
    }
?>
...
?>
<!-- Fim do armazenamento dos dados nas variáveis -->
